...
public class Program3{
  ...
  public static void main(String[] args) throws Exception{
    ...
    File inpufile = new File("inputfile.txt");  //File to be scanned for data
  ...
  public static void findAgeDifference(int currentYear, int currentMonth, int currentDay, int recordYear, int recordMonth, int recordDay){
    ...
    int yearDifference, monthDifference, dayDifference  //Variables for difference in dates
    ...
    //if record's day of the month is ahead of the current day, add the total days during the record's month to the amount in current days and subtract 1 month from current month to compensate
    if (currentDay<recordDay){
      currentDay+=days;
      currentMonth-=1;
    }
    //if record's date is not invalid, do the computations and print out the age of the record
  ...
  //Method used to find current date in the form of year/month/day, then splitting year, month and day into separate values and returning the array of these values
